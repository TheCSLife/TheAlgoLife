  ...
  public static void main(String[]args)throws Exception{
    ...
    // 숫자 문자열
      ...
      while(numX>0){ // 현재 숫자에서 나오는 0~9 체크
        int remain=(int)numX%10;if(!number[remain]){number[remain]=true;find++;}
    ...
    System.out.println("#"+T+" "+(N*count));}// test
  }
}
